...
import 'package:not_notes/core/constants/config_constants.dart';
import 'package:not_notes/core/constants/note_constants.dart';
import 'package:not_notes/core/dependencies/dependency.dart';
...
Future<void> initSingletons() async {
  ...
  // Blocs
  dependency.registerSingleton<ConfigBloc>(ConfigBloc(dependency(), dependency()));

  // ---

  // Notes

  var box = await Hive.openBox<NoteEntity>(noteBox);
